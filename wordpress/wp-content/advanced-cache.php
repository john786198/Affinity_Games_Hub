...
$nitropack_functions_file = 'C:\xampp\htdocs\Affinity_Games_Hub\wordpress\wp-content\plugins\nitropack\functions.php';
$nitropack_abspath = 'C:\xampp\htdocs\Affinity_Games_Hub\wordpress/';
...
if (file_exists($nitropack_functions_file) && ABSPATH == $nitropack_abspath) {
    ...
    define( 'NITROPACK_ADVANCED_CACHE_VERSION', '1.8.3');
    define( 'NITROPACK_LOGGED_IN_COOKIE', 'wordpress_logged_in_d55ae0109e9b56c9180bbcb3fe4406b3' );
